    ...
    useEffect(() => {
        const options = {
            ...
            headers: {
                ...
                Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJhZGJmYWYxMWJmOTM0ZjliZGQzNjdiMTI3ODE5ZTVlMSIsIm5iZiI6MTc0MTYzNzQ5NC4yMjMsInN1YiI6IjY3Y2Y0Nzc2M2MyNTQ0NDg4MmUzMzEzZiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.Wpo8JCwM921r1EG1_MgVAA37j8K7Ra-VvsCQsi9fGTY'
            }
        };
    ...
    return (
        <GenresContext.Provider value={genres}>
            <section className='MovieApp'>
                <Tabs
                    isClicked={isClickedButtonRated}
                />
                <Search
                    onCreate={onCreate}
                    isClicked={isClicked}
